...
//         ImportProjectToBundle(exampleNest, ".", "example-client");
//         ImportProjectToBundle(exampleNest, ".", "example-daemon");
//
...
//         ImportProjectToBundle(nestNest, "..", "nestd");
//         ImportProjectToBundle(nestNest, "..", "nest-host");
//         ImportProjectToBundle(nestNest, "..", "dev-nest-commander");
//
