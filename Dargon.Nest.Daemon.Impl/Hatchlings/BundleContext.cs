...
namespace Dargon.Nest.Daemon.Hatchlings {
   ...
   public class BundleContextImpl : BundleContext {
      ...
      private readonly ManageableBundle bundle;

      public BundleContextImpl(string nestName, string nestPath, ManageableBundle bundle) {
